...
def plain_register_dataset():
    ...
    DatasetCatalog.register(
        "taco_train", lambda: load_coco_json(TRAIN_JSON, TRAIN_PATH))
    MetadataCatalog.get("taco_train").set(thing_classes=CLASS_NAMES,
                                               evaluator_type='coco',
                                               json_file=TRAIN_JSON,
                                               image_root=TRAIN_PATH)
    DatasetCatalog.register(
        "taco_val", lambda: load_coco_json(VAL_JSON, VAL_PATH))
    MetadataCatalog.get("taco_val").set(thing_classes=CLASS_NAMES,
                                             evaluator_type='coco',
                                             json_file=VAL_JSON,
                                             image_root=VAL_PATH)
